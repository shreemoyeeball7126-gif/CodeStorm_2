...
def load_model():
    """
    Load the pre-trained model bundle. If the pickle can't be unpickled
    (e.g. a scikit-learn/numpy version mismatch between where it was trained
    and where the app is deployed), retrain it on the fly from the dataset
    ...
    try:
        ...
        return {"model": pipe, "features": FEATURES, "model_name": "LinearRegression (retrained)"}
